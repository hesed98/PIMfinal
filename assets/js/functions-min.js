...
!function(t,e,i,n){
    ...
    function l(t,e,i){
        var n=e.prototype,s;s=t.prototype=Object.create(n),s.constructor=t,s._super=n,i&&Tt(s,i)
    }
    function c(t,e){
        return function i(){
    ...
    function C(t,e){
        for(var i,s,r=e[0].toUpperCase()+e.slice(1),o=0;o<dt.length;){
            if(i=dt[o],s=i?i+r:e,s in t)return s;o++
        }
        return n
    }
    function E(){
    ...
    function x(e){
        ...
        function A(t,e,i){
            var n=i.pointers.length,s=i.changedPointers.length,r=e&Pt&&n-s===0,o=e&(Rt|Mt)&&n-s===0;
        ...
        function D(t,e){
            ...
            var r=i.firstInput,o=i.firstMultiple,a=o?o.center:r.center,l=e.center=P(n);
        ...
        function _(t,e){
            ...
            e.eventType!==Pt&&r.eventType!==Rt||(s=t.prevDelta={x:r.deltaX||0,y:r.deltaY||0},n=t.offsetDelta={x:i.x,y:i.y}),e.deltaX=s.x+(i.x-n.x),e.deltaY=s.y+(i.y-n.y)}function S(t,e){var i=t.lastInterval||e,s=e.timeStamp-i.timeStamp,r,o,a,l;
                if(e.eventType!=Mt&&(s>bt||i.velocity===n)){
                    var c=e.deltaX-i.deltaX,h=e.deltaY-i.deltaY,u=O(s,c,h);o=u.x,a=u.y,r=mt(u.x)>mt(u.y)?u.x:u.y,l=R(c,h),t.lastInterval=e
            ...
            function P(t){
                ...
                for(var i=0,n=0,s=0;e>s;)
                    i+=t[s].clientX,n+=t[s].clientY,s++;return{x:vt(i/e),y:vt(n/e)
                    }
                }
                function O(t,e,i){
                    return{
                ...
                function M(t,e,i){
                    i||(i=Ht);var n=e[i[0]]-t[i[0]],s=e[i[1]]-t[i[1]];
                ...
                function H(t,e){
                    ...
                    if(r=i.filter(function(t){return f(t.target,l)}),e===Pt)
                        for(s=0;s<r.length;)
                    ...
                    function L(){
                        ...
                        this.touch=new W(this.manager,t),this.mouse=new Y(this.manager,t),this.primaryTouch=null,this.lastTouches=[]}function V(t,e){t&Pt?(this.primaryTouch=e.
                            changedPointers[0].identifier,U.call(this,e)):t&(Rt|Mt)&&U.call(this,e)}function U(t){var e=t.changedPointers[0];
                        ...
                        function j(t){
                            for(var e=t.srcEvent.clientX,i=t.srcEvent.clientY,n=0;n<this.lastTouches.length;n++){
                                    var s=this.lastTouches[n],r=Math.abs(e-s.x),o=Math.abs(i-s.y);if(se>=r&&se>=o)return!0
                                }
                                return!1
                            }
                            function G(t,e){
                            ...
                            function B(t){
                                if(v(t,he))return he;
                                var e=v(t,ue),i=v(t,de);
                                return e&&i?he:e||i?e?ue:de:v(t,ce)?ce:le
                            }
                            function Z(){
                                if(!oe)return!1;
                                var e={},i=t.CSS&&t.CSS.supports;
                                return["auto","manipulation","pan-y","pan-x","pan-x pan-y","none"].forEach(function(n){e[n]=i?t.CSS.supports("touch-action",n):!0
                            }),e
                            }
                            function J(t){
                            ...
                            function ct(t,e){
                                this.options=Tt({},lt.defaults,e||{}),this.options.inputTarget=this.options.inputTarget||t,this.handlers={},this.session={},this.recognizers=[],this.oldCssProps={},this.element=t,this.input=w(this),this.touchAction=new G(this,this.options.touchAction),ht(this,!0),o(this.options.recognizers,function(t){var e=this.add(new t[0](t[1]));t[2]&&e.recognizeWith(t[2]),t[3]&&e.requireFailure(t[3])},this)
                            }
                            function ht(t,e){
                                var i=t.element;
                                if(i.style){
                                    var n;o(t.options.cssProps,function(s,r){
